...
schedule <- tibble::tribble(
  ...
  "10/28",  "Visualization & reporting",
  "11/4",   "No class (academic holiday)",
  "11/11",  "Presentations",
  "11/18",  "Project planning",
  "11/25",  "Data cleaning & analysis",
  "12/2",   "Visualization & reporting",
  "12/9",   "Presentations",
)

deadlines <- c(
  "Project 1 report" = "10/14",
  "Project 2 report" = "11/18",
  "Project 3 report" = "12/16"
)

deadlines_table <- knitr::kable(deadlines, col.names = "Due Date")
