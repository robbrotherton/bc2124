...
schedule <- tibble::tribble(
  ...
  "9/23",   "Data cleaning",             "",
  "9/30",   "Analysis",                  "Presentation slide",
  "10/7",   "Presentations",             "Project 1 report",
  "10/14",  "Project planning",          "",
  "10/21",  "Data cleaning & analysis",  "",
  "10/28",  "Visualization & reporting", "Presentation slide",
  "11/4",   "No class (academic holiday)","",
  "11/11",  "Presentations",             "Project 2 report",
  "11/18",  "Project planning",          "",
  "11/25",  "Data cleaning & analysis",  "",
  "12/2",   "Visualization & reporting", "Presentation slide",
  "12/9",   "Presentations",             "Project 3 report"
)
...
schedule_table <- knitr::kable(schedule) |>
  ...
  kableExtra::pack_rows("Project 1: t-test", 2, 5, indent = FALSE) |>
  kableExtra::pack_rows("Project 2: Correlation", 6, 10, indent = FALSE) |>
  kableExtra::pack_rows("Project 3: Regression", 11, 14, indent = FALSE) |>
...
__Co-requisite__: PSYC BC2125 Personality Psychology
