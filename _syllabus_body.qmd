...
schedule <- tibble::tribble(
  ...
  "11/6",   "No class (academic holiday)","",
  "11/13",  "Presentations",             "Project 2 report",
  "11/20",  "Scale planning",            "",
  "11/27",  "Questionnaire design",      "",
...
__Pre-requisites__: PSYC BC1001 Introduction to Psychology; PSYC BC1101 Statistics; PSYC BC1024 Research Methods  
...
knitr::kable(schedule) |>
  ...
  kableExtra::pack_rows("Project 2: Multiple regression", 6, 10, indent = FALSE) |>
  kableExtra::pack_rows("Project 3: Scale design", 11, 14, indent = FALSE) |>
