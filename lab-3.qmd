...
You should begin this session with variables form the ANES 2016 dataset in mind for your analysis. In class we will introduce the R language and RStudio environment, and perform necessary data cleaning and manipulation in preparation for analysis.
...
my_data_complete <- my_data_complete |>
    mutate(extraversion_mean = (extraversion1 + extraversion2) / 2)
