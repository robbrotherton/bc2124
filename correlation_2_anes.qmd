...
Don't forget to take a look at the data.frame object to make sure it's as you expect. One way is to click on the name in the Environment pane to view the data as a spreadsheet in a new tab. You can also check it out using code:
